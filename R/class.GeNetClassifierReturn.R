...
setClass(Class="GeNetClassifierReturn",
	...
	# setMethod(f="plot", signature=c(x="GeNetClassifierReturn", y="missing"), definition=function (x, y, fileName=NULL, lpThreshold=0.75, numGenesLpPlot=1000, numGenesNetworkPlot=100, geneLabels=NULL, verbose=TRUE, ...)
	# {
	...
	plot.GeNetClassifierReturn <- function (x, y="missing", fileName=NULL, lpThreshold=0.75, numGenesLpPlot=1000, numGenesNetworkPlot=100, geneLabels=NULL, verbose=TRUE, ...)
	{ 
		plotGeNetClassifierReturn( geNetClassifierReturn=x, fileName=fileName, lpThreshold=lpThreshold, numGenesLpPlot=numGenesLpPlot, numGenesNetworkPlot=numGenesNetworkPlot, geneLabels=geneLabels, verbose=verbose)
	}
